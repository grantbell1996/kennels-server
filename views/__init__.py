...
from .employee_requests import get_all_employees, get_single_employee, create_employee, get_employees_by_location
from .customer_requests import get_all_customers, get_single_customer, create_customer, get_customers_by_email